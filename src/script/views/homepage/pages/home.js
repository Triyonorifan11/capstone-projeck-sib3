  ...
  <div class="container" style="padding: 5rem;">
    ...
    <div class="d-flex justify-content-center">
      <div class="col-12 p-3">
        <p class="text-center fs-5">Dengan hadirnya RT Project akan membantu mengurangi volume sampah di Indonesia.</p>
      </div>
    </div>
